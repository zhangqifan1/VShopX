...
public class ShopcartAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (child != null) {
            ...
            GlideLoadImageUtil.load(mcontext,child.getGoodsImg(),childViewHolder.goodsImage);
            childViewHolder.goods_size.setText("颜色:" + child.getColor() + ",大小:" + child.getSize());
            //设置打折前的原价
            ...
            childViewHolder.delGoods.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    DialogUtil.showNagPosDialog(mcontext, "移除这件商品？", new SweetAlertDialog.OnSweetClickListener() {
                        @Override
    ...
    private void showDialog(final int groupPosition, final int childPosition, final View showCountView,final  boolean isChecked, final  GoodsInfo child) {
        ...
        dialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialog) {
                KeyboardUtil.showKeyboard(mcontext,showCountView);
            }
        });
